<%@ Page Title="" Language="C#" MasterPageFile="~/asp/Backstage/BackIndex.Master" AutoEventWireup="true" CodeBehind="AuditedList.aspx.cs" Inherits="ENR_UI.asp.Backstage.AuditedList" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form ID="Content2">
        ...
        <div class="pageTool">
                <a href="AuditedList.aspx?pageIndex=1">首页</a>
                <%if (pageIndex == 1){%>
                上一页
                <%}else{ %>
                 <a href="AuditedList.aspx?pageIndex=<%=pageIndex-1 %>">上一页</a>
                <%} %>
               
                <%if (pageIndex == pageTotal){%>
                下一页
                <%}else{ %>
                <a href="AuditedList.aspx?pageIndex=<%=pageIndex+1 %>">下一页</a>
                <%} %>
                
                <a href="AuditedList.aspx?pageIndex=<%=pageTotal %>">尾页</a>
